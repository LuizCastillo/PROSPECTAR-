...
// Chaves ausentes (Google Maps, LLM) ficam undefined de propósito: os módulos
// que dependem delas devem checar e retornar UNKNOWN/erro claro, nunca inventar dado.
